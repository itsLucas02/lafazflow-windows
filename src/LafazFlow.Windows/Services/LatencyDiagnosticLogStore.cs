...
public sealed partial class LatencyDiagnosticLogStore
{
    ...
    public static LatencyDiagnosticRow? ParseLine(string line)
    {
        ...
        return new LatencyDiagnosticRow(
            ...
            Value(fields, "target"),
            Value(fields, "toggle_dispatch_ms"),
            Value(fields, "hotkey_to_visible_ms"),
            Value(fields, "recording_ms"),
            Value(fields, "stop_hotkey_to_queue_ms"),
            Value(fields, "queue_wait_ms"),
            Value(fields, "preview_start_ms"),
            Value(fields, "preview_stop_ms"),
            Value(fields, "whisper_ms"),
            Value(fields, "paste_ms"),
            Value(fields, "audio_drain_ms"),
            Value(fields, "wave_finalize_ms"),
            Value(fields, "model_load_ms"),
            Value(fields, "inference_ms"),
            Value(fields, "response_transfer_ms"),
            Value(fields, "raw_chars"),
            Value(fields, "formatted_chars"),
            Value(fields, "clipboard_chars"),
            Value(fields, "raw_final_char"),
            Value(fields, "formatted_final_char"),
            Value(fields, "clipboard_final_char"),
            Value(fields, "ui_hide_ms"),
